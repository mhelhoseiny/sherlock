function [scores,list_im] = matcaffe_batch_detail_py(list_im,  model_def_file, model_file, CROPPED_DIM, use_gpu)
...
for bb = 1 : num_batches
    ...
    tic
    input_data = prepare_batch(list_im(range),IMAGE_MEAN,batch_size,CROPPED_DIM);
    toc, tic
